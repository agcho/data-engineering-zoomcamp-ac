...
> bruin run ./my-pipeline/pipeline --start-date 2022-01-01 --end-date 2022-02-01
> bruin run ./my-pipeline/pipeline/assets/staging/trips.sql --start-date 2022-01-01 --end-date 2022-02-01 --full-refresh
> bruin run ./my-pipeline/pipeline/assets/reports/trips_report.sql --start-date 2022-01-01 --end-date 2022-02-01 --full-refresh
> bruin run ./my-pipeline/pipeline --full-refresh
